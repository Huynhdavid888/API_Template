...
namespace Mock_BestBuy_API
{
    public class ProductRepo : IProductRepo
    {
        ...
        {
            connection.Execute("DELETE from bestbuy.products WHERE ProductID = @id", new { id = prod.ProductID });
            connection.Execute("DELETE from bestbuy.reviews WHERE ProductID = @id", new { id = prod.ProductID });
            connection.Execute("DELETE from bestbuy.sales WHERE ProductID = @id", new { id = prod.ProductID });
